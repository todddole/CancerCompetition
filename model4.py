...
def center_crop(image, crop_size=(40, 40)):
    """
...
train_datagen = ImageDataGenerator(
    ...
    preprocessing_function=lambda img: center_crop(img, crop_size=(40, 40))
)
...
with open('training_log-model4.json', 'w') as f:
    json.dump(history.history, f)

with open('fine_tuning_log-model4.json', 'w') as f:
